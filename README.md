...
```bash
git clone https://github.com/rjsarkar83/Converter.git
cd Converter
...
**GitHub Pages** (`https://rjsarkar83.github.io/Converter/`) is a homepage only. It cannot convert files. Always use `http://127.0.0.1:5000` after `python app.py`.

**CDR → PDF** uses LibreOffice/libcdr then Ghostscript `/prepress` (print quality, vectors kept). Optional screen or rasterize modes. CorelDRAW “Publish to PDF” is still the only 1:1 Corel proof.
